  ...
  return (
    <div className="bg-[#1f1f22]">
      <div className="text-white  h-screen flex justify-center items-center p-2">
        <div className="bg-black p-2 rounded-xl w-1/2 flex  gap-2 items-center justify-around">
          ...
          <div className="flex flex-col gap-3">
            <input value={username} onChange={(e) => setUsername(e.target.value)} type="text" className="border" />
            <button onClick={signin} className="border">Next</button>
          </div>
        </div>
      </div>
    </div>
